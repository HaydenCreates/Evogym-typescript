...
const ContactUs = ({setSelectedPage}: Props) => {
    ...
    // any- used for sistuations that are ambiguous
    const onSubmit = async(e: any) =>{
        const isValid = await trigger();

        //prevents refresh if there are errors
        if(!isValid){
            e.preventDefault();
        }
    }
  ...
  return <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
    ...
    >
        ...
        >
            ...
            <p className="my-5">
                Have questions about our memberships, class schedules, or training options? We're here to help! Reach out to our friendly team and get started on your fitness journey today. 
            </p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
            ...
            >
                <div className="md:before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-z]">
